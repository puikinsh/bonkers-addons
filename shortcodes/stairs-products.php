...
* @return void
*/
function bonkers_addons_component_stairs_products() {
    ...
    vc_map(
        array(
            'name' => esc_html__( 'ShopApp Stairs Products', 'bonkers-addons' ),
            'description' => esc_html__( 'Display a stairs of products.', 'bonkers-addons' ),
            'base' => 'shopapp_stairs_products',
            'category' => esc_html__( 'Content', 'bonkers-addons' ),
            'icon' => BONKERS_ADDONS__PLUGIN_URL . '/images/vc_stairs_products.png',
            'params' => array(
                array(
                    'type' => 'dropdown',
                    'class' => '',
...
add_action( 'vc_before_init', 'bonkers_addons_component_stairs_products' );
...
*/
function bonkers_addons_stairs_products_function( $atts, $content ) {
    ...
    if ( $display && in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
        ...
        $html .='<div class="shopapp-stairs-products">';
        ...
        }elseif( $term_exists !== 0 && $term_exists !== null ){ //If is WoooCommerce Category
        ...
        $html .='</div><!-- /.shopapp-stairs-products-->';

    }
    return $html;
}
add_shortcode( 'shopapp_stairs_products', 'bonkers_addons_stairs_products_function' );
