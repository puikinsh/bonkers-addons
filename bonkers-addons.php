	...
	if ( 'Bonkers' == $bonker_addons_current_theme->get( 'Name' ) ) {
		...
		function bonkers_addons_customize_register( $wp_customize ) {
			...
			$wp_customize->add_panel( 'bonkers_addons_front_page_sections', array(
				...
				$wp_customize->add_setting( 'bonkers_addons_welcome_title', array(
					'type' => 'option',
				...
				$wp_customize->add_setting( 'bonkers_addons_welcome_link_title', array(
					'type' => 'option',
				...
				$wp_customize->add_setting( 'bonkers_addons_welcome_link_url', array(
					'type' => 'option',
					'default' => '#',
					'transport' => 'postMessage',
				...
				$wp_customize->add_setting( 'bonkers_addons_welcome_enable', array(
					'type' => 'option',
					'default' => 1,
					'transport' => 'refresh',
			...
			if ( class_exists( 'Epsilon_Control_Toggle' ) ) {
				...
				$wp_customize->add_control( 'bonkers_addons_welcome_enable', array(
					'type' => 'checkbox',
					'section' => 'bonkers_addons_welcome_section', // Required, core or custom.
					'label' => esc_attr__( 'Use this section?', 'bonkers-addons' ),
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_services_enable', array(
					'type' => 'option',
					'default' => '1',
					'transport' => 'refresh',
					'sanitize_callback' => 'bonkers_addons_sanitize_integer',
			...
			if ( class_exists( 'Epsilon_Control_Toggle' ) ) {
				$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, 'bonkers_addons_services_enable', array(
					'label'    => esc_attr__( 'Use this section?', 'bonkers-addons' ),
					'section'  => 'bonkers_addons_services_section',
				) ) );
			} else {
				$wp_customize->add_control( 'bonkers_addons_services_enable', array(
					'type' => 'checkbox',
					'section' => 'bonkers_addons_welcome_section', // Required, core or custom.
					'label' => esc_attr__( 'Use this section?', 'bonkers-addons' ),
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_services_text', array(
					'type' => 'option',
					'default' => '',
					'sanitize_callback' => 'bonkers_addons_sanitize_text',
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_image_title', array(
					'type' => 'option',
				...
				$wp_customize->add_setting( 'bonkers_addons_image_text', array(
					'type' => 'option',
					'default' => '',
					'transport' => 'postMessage',
					'sanitize_callback' => 'bonkers_addons_sanitize_text_html',
			...
			if ( class_exists( 'Epsilon_Control_Text_Editor' ) ) {
				...
				$wp_customize->add_setting( 'bonkers_addons_image_link_title', array(
					'type' => 'option',
				...
				$wp_customize->add_setting( 'bonkers_addons_image_link_url', array(
					'type' => 'option',
					'default' => '#',
					'transport' => 'postMessage',
					'sanitize_callback' => 'bonkers_addons_sanitize_url',
				...
				$wp_customize->add_control( new Bonkers_Radio_Image_Control( $wp_customize, 'bonkers_addons_image_layout', array(
					'section'     => 'bonkers_addons_image_section',
				...
				$wp_customize->add_setting( 'bonkers_addons_image_enable', array(
					'type' => 'option',
					'default' => '1',
					'transport' => 'refresh',
					'sanitize_callback' => 'bonkers_addons_sanitize_integer',
			...
			if ( class_exists( 'Epsilon_Control_Toggle' ) ) {
				$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, 'bonkers_addons_image_enable', array(
					'label'    => esc_attr__( 'Use this section?', 'bonkers-addons' ),
					'section'  => 'bonkers_addons_image_section',
				) ) );
			} else {
				$wp_customize->add_control( 'bonkers_addons_image_enable', array(
					'type' => 'checkbox',
					'section' => 'bonkers_addons_image_section', // Required, core or custom.
					'label' => esc_attr__( 'Use this section?', 'bonkers-addons' ),
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_phone_image', array(
					'type' => 'option',
					'default' => '',
					'transport' => 'postMessage',
					'sanitize_callback' => 'bonkers_addons_sanitize_url',
				...
				$wp_customize->add_setting( 'bonkers_addons_phone_text_left', array(
					'type' => 'option',
					'default' => '',
					'sanitize_callback' => 'bonkers_addons_sanitize_text',
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_phone_text_right', array(
					'type' => 'option',
					'default' => '',
					'sanitize_callback' => 'bonkers_addons_sanitize_text',
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_phone_color', array(
					'default' => '#f7f7f7',
					'transport' => 'postMessage',
				...
				$wp_customize->add_setting( 'bonkers_addons_phone_enable', array(
					'type' => 'option',
					'default' => '1',
					'transport' => 'refresh',
					'sanitize_callback' => 'bonkers_addons_sanitize_integer',
			...
			if ( class_exists( 'Epsilon_Control_Toggle' ) ) {
				$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, 'bonkers_addons_phone_enable', array(
					'label'    => esc_attr__( 'Use this section?', 'bonkers-addons' ),
					'section'  => 'bonkers_addons_phone_section',
				) ) );
			} else {
				$wp_customize->add_control( 'bonkers_addons_phone_enable', array(
					'type' => 'checkbox',
					'section' => 'bonkers_addons_phone_section', // Required, core or custom.
					'label' => esc_attr__( 'Use this section?', 'bonkers-addons' ),
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_cta_title', array(
					'type' => 'option',
				...
				$wp_customize->add_setting( 'bonkers_addons_cta_link_title', array(
					'type' => 'option',
				...
				$wp_customize->add_setting( 'bonkers_addons_cta_link_url', array(
					'type' => 'option',
					'default' => '#',
					'transport' => 'postMessage',
					'sanitize_callback' => 'bonkers_addons_sanitize_url',
				...
				$wp_customize->add_setting( 'bonkers_addons_cta_enable', array(
					'type' => 'option',
					'default' => '1',
					'transport' => 'refresh',
					'sanitize_callback' => 'bonkers_addons_sanitize_integer',
			...
			if ( class_exists( 'Epsilon_Control_Toggle' ) ) {
				$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, 'bonkers_addons_cta_enable', array(
					'label'    => esc_attr__( 'Use this section?', 'bonkers-addons' ),
					'section'  => 'bonkers_addons_cta_section',
				) ) );
			} else {
				$wp_customize->add_control( 'bonkers_addons_cta_enable', array(
					'type' => 'checkbox',
					'section' => 'bonkers_addons_cta_section', // Required, core or custom.
					'label' => esc_attr__( 'Use this section?', 'bonkers-addons' ),
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_video_title', array(
					'type' => 'option',
				...
				$wp_customize->add_setting( 'bonkers_addons_video_text', array(
					'type' => 'option',
					'default' => '',
					'transport' => 'postMessage',
					'sanitize_callback' => 'bonkers_addons_sanitize_text_html',
			...
			if ( class_exists( 'Epsilon_Control_Text_Editor' ) ) {
				...
				$wp_customize->add_setting( 'bonkers_addons_video_url', array(
					'type' => 'option',
					'default' => '',
					'sanitize_callback' => 'bonkers_addons_sanitize_url',
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_video_enable', array(
					'type' => 'option',
					'default' => '1',
					'transport' => 'refresh',
					'sanitize_callback' => 'bonkers_addons_sanitize_integer',
			...
			if ( class_exists( 'Epsilon_Control_Toggle' ) ) {
				$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, 'bonkers_addons_video_enable', array(
					'label'    => esc_attr__( 'Use this section?', 'bonkers-addons' ),
					'section'  => 'bonkers_addons_video_section',
				) ) );
			} else {
				$wp_customize->add_control( 'bonkers_addons_video_enable', array(
					'type' => 'checkbox',
					'section' => 'bonkers_addons_video_section', // Required, core or custom.
					'label' => esc_attr__( 'Use this section?', 'bonkers-addons' ),
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_team_title', array(
					'type' => 'option',
				...
				$wp_customize->add_setting( 'bonkers_addons_team_text', array(
					'type' => 'option',
					'default' => '',
					'sanitize_callback' => 'bonkers_addons_sanitize_text',
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_team_enable', array(
					'type' => 'option',
					'default' => '1',
					'transport' => 'refresh',
					'sanitize_callback' => 'bonkers_addons_sanitize_integer',
			...
			if ( class_exists( 'Epsilon_Control_Toggle' ) ) {
				$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, 'bonkers_addons_team_enable', array(
					'label'    => esc_attr__( 'Use this section?', 'bonkers-addons' ),
					'section'  => 'bonkers_addons_team_section',
				) ) );
			} else {
				$wp_customize->add_control( 'bonkers_addons_team_enable', array(
					'type' => 'checkbox',
					'section' => 'bonkers_addons_team_section', // Required, core or custom.
					'label' => esc_attr__( 'Use this section?', 'bonkers-addons' ),
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_subscribe_title', array(
					'type' => 'option',
				...
				$wp_customize->add_setting( 'bonkers_addons_subscribe_text', array(
					'type' => 'option',
					'default' => '',
					'transport' => 'postMessage',
					'sanitize_callback' => 'bonkers_addons_sanitize_text_html',
			...
			if ( class_exists( 'Epsilon_Control_Text_Editor' ) ) {
				...
				$wp_customize->add_setting( 'bonkers_addons_subscribe_link_title', array(
					'type' => 'option',
					'default' => esc_html__( 'Subscribe', 'bonkers-addons' ),
					'transport' => 'postMessage',
					'sanitize_callback' => 'bonkers_addons_sanitize_text',
				...
				$wp_customize->add_setting( 'bonkers_addons_subscribe_link_placeholder', array(
					'type' => 'option',
			...
			if ( class_exists( 'Epsilon_Control_Toggle' ) ) {
				$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, 'bonkers_addons_subscribe_enable', array(
					'label'    => esc_attr__( 'Use this section?', 'bonkers-addons' ),
					'section'  => 'bonkers_addons_subscribe_section',
				) ) );
			} else {
				$wp_customize->add_control( 'bonkers_addons_subscribe_enable', array(
					'type' => 'checkbox',
					'section' => 'bonkers_addons_subscribe_section', // Required, core or custom.
					'label' => esc_attr__( 'Use this section?', 'bonkers-addons' ),
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_clients_title', array(
					'type' => 'option',
				...
				$wp_customize->add_setting( 'bonkers_addons_clients_text', array(
					'type' => 'option',
					'default' => '',
					'sanitize_callback' => 'bonkers_addons_sanitize_text',
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_clients_enable', array(
					'type' => 'option',
					'default' => '1',
					'transport' => 'refresh',
					'sanitize_callback' => 'bonkers_addons_sanitize_integer',
			...
			if ( class_exists( 'Epsilon_Control_Toggle' ) ) {
				...
				$wp_customize->add_control( 'bonkers_addons_clients_enable', array(
					'type' => 'checkbox',
					'section' => 'bonkers_addons_clients_section', // Required, core or custom.
					'label' => esc_attr__( 'Use this section?', 'bonkers-addons' ),
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_contact_title', array(
					'type' => 'option',
				...
				$wp_customize->add_setting( 'bonkers_addons_contact_key', array(
					'type' => 'option',
					'default' => '',
					'sanitize_callback' => 'bonkers_addons_sanitize_text',
				) );
				...
				$wp_customize->add_setting( 'bonkers_addons_contact_address', array(
					'type' => 'option',
					'default' => 'Central Park, New York, NY, United States',
					'sanitize_callback' => 'bonkers_addons_sanitize_text',
				) );
				$wp_customize->add_control( 'bonkers_addons_contact_address', array(
					'type' => 'text',
					'section' => 'bonkers_addons_contact_section', // Required, core or custom.
					'label' => esc_attr__( 'Address', 'bonkers-addons' ),
				) );

				$wp_customize->add_setting( 'bonkers_addons_contact_zoom', array(
					'type' => 'option',
					'default' => '13',
					'sanitize_callback' => 'bonkers_addons_sanitize_integer',
				) );
				$wp_customize->add_control( new Epsilon_Control_Slider( $wp_customize, 'bonkers_addons_contact_zoom', array(
					'type' => 'epsilon-slider',
			...
			if ( ! Bonkers_Helper::has_plugin( 'contact-form-7' ) ) {
				$wp_customize->add_setting( 'bonkers_addons_installcf7', array(
					'type' => 'option',
					'default' => '',
					'sanitize_callback' => 'bonkers_addons_sanitize_text',
				) );
				...
				if ( empty( $bonkers_addons_forms ) ) {
					$wp_customize->add_setting( 'bonkers_addons_create_form', array(
						'type' => 'option',
						'default' => '',
						'sanitize_callback' => 'bonkers_addons_sanitize_text',
					) );
					...
					$wp_customize->add_setting( 'bonkers_addons_contact_form', array(
						'type' => 'option',
						'default' => '0',
						'sanitize_callback' => 'bonkers_addons_sanitize_text',
					) );
				...
				$wp_customize->add_setting( 'bonkers_addons_contact_enable', array(
					'type' => 'option',
					'default' => '1',
					'transport' => 'refresh',
					'sanitize_callback' => 'bonkers_addons_sanitize_integer',
			...
			if ( class_exists( 'Epsilon_Control_Toggle' ) ) {
				$wp_customize->add_control( new Epsilon_Control_Toggle( $wp_customize, 'bonkers_addons_contact_enable', array(
					'label'    => esc_attr__( 'Use this section?', 'bonkers-addons' ),
					'section'  => 'bonkers_addons_contact_section',
				) ) );
			} else {
				$wp_customize->add_control( 'bonkers_addons_contact_enable', array(
					'type' => 'checkbox',
					'section' => 'bonkers_addons_contact_section', // Required, core or custom.
					'label' => esc_attr__( 'Use this section?', 'bonkers-addons' ),
				) );
